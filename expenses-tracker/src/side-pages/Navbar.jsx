...
function Navbar() {
    ...
    return (
        <nav id="navbar-container" className="navbar navbar-expand-lg navbar-light bg-light px-4">
            <div className="d-flex w-100 justify-content-between">
                {user ? (
                    ...
                    <ul className="navbar-nav d-flex flex-row ms-auto">
                        <li className="nav-item me-2"><Link to="/log-in" className="nav-link">Log in</Link></li>
